...
int main()
{
    ...
    // Allocating memory space for an array  of size double vars. First 5 will be initialized with 1,2,3,4,5, and the  rest will be 0's.
    ...
    // cout << "p_scores1 size : " <<size(p_scores) << endl;//doesn't work for normal pointer
